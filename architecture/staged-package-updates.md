...
`dpkg --simulate --refuse-downgrade --force-confold --install --recursive <root-owned-deb-dir>`
...
`dpkg --refuse-downgrade --force-confold --install --recursive <root-owned-deb-dir>`
